...
class LaplaceDist(BaseDist):
    """Laplace Distribution for L1 loss.
    
    Using Negative Log-Likelihood of Laplace distribution yields the L1 Loss.
    L1 Loss is known to produce sharper images in generative tasks than L2 (MSE).
    """
    ...
    def log_prob(self, value):
        ...
        distance = torch.abs(self._mode - value)
